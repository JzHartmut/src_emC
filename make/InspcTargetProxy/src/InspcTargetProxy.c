...
void init_InspcTargetProxy(InspcTargetProxy_s* thiz)
{
  ...
  setAddrSegm_MemSegmJc(rootAddr, receive, 1);
 ...
 */
int32 getInfo_InspcTargetProxy(InspcTargetProxy_s* thiz, Cmd_InspcTargetProxy_e cmd, struct RemoteAddressJc* address, int32 input)
{ int32 ret = -1;
...
int32 InspcTargetProxySharedMem::accessTarget(Cmd_InspcTargetProxy_e cmd, int device, struct RemoteAddressJc* address, int32 input) {
