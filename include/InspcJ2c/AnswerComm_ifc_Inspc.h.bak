...
/**J2c: Definitions of the enhanced reference. It's conditinally because it may be defined in a included header before. */
  ...
  struct AnswerComm_ifc_Inspc_t;
    ...
    typedef struct AnswerComm_ifc_InspcREF_t STRUCT_REFJc(struct AnswerComm_ifc_Inspc_t) AnswerComm_ifc_InspcREF;
  #else
    //J2C: simple reference instead enhanced reference if macro is not defined
    #define AnswerComm_ifc_InspcREF struct AnswerComm_ifc_Inspc_t* 
  #endif
#endif
