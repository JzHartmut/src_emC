...
/**J2c: Definitions of the enhanced reference. It's conditinally because it may be defined in a included header before. */
  ...
  struct CmdConsumer_ifc_Inspc_t;
    ...
    typedef struct CmdConsumer_ifc_InspcREF_t STRUCT_REFJc(struct CmdConsumer_ifc_Inspc_t) CmdConsumer_ifc_InspcREF;
  #else
    //J2C: simple reference instead enhanced reference if macro is not defined
    #define CmdConsumer_ifc_InspcREF struct CmdConsumer_ifc_Inspc_t* 
  #endif
#endif
