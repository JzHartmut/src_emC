...
{ \
  \
  fill_mB_ArraysJc(/*static*/(THIZ)->data, (THIZ)->idxBegin, (THIZ)->idxBegin + (THIZ)->sizeHead, (int8)0, _thCxt);\
}
...
{ \
  \
  fill_mB_ArraysJc(/*static*/(THIZ)->data, (THIZ)->idxBegin, (THIZ)->idxEnd, (int8)0, _thCxt);\
}
