 ...
 */
  ...
  struct ByteDataAccessJc_t;
    ...
    typedef struct ByteDataAccessJcREF_t STRUCT_REFJc(struct ByteDataAccessJc_t) ByteDataAccessJcREF;
  #else
    //J2C: simple reference instead enhanced reference if macro is not defined
    #define ByteDataAccessJcREF struct ByteDataAccessJc_t* 
  #endif
#endif
...
/**J2c: Definitions of the enhanced reference. It's conditinally because it may be defined in a included header before. */
  ...
  #else
    //J2C: simple reference instead enhanced reference if macro is not defined
    #define ByteDataAccessJcREF struct ByteDataAccessJc* 
  #endif
#endif
