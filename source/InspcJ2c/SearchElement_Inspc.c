...
{ SearchElement_Inspc_s* ythis = (SearchElement_Inspc_s*)othis;  //upcasting to the real class.
...
{ SearchTrc_SearchElement_Inspc_s* ythis = PTR_MemC(mthis, SearchTrc_SearchElement_Inspc_s);  //reference casting to the real class.
  ...
  {
    //J2C: constructor for embedded element
      INIT_MemSegmJc(/*static*/ythis->objWhereFieldIsFound);
    //J2C: constructor for embedded element
      INIT_MemSegmJc(/*static*/ythis->objOfField);
  }/*J2C:No body for constructor*/
