...
{ { sign_Mtbl_InspcDataExchangeAccess_Inspc //J2C: Head of methodtable of InspcDataExchangeAccess_Inspc
...
{ 
  ...
  { 
    ...
    int32  nr = getInt8_i_ByteDataAccessBaseJc(& ((* (thiz)).base.super), kanswerNr_InspcDatagram_InspcDataExchangeAccess_Inspc, _thCxt);
    nr |= 0x80;
