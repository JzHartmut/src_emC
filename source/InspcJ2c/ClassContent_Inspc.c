  ...
  { /*:this.maxNrofAnswerBytes = maxNrofAnswerBytes;*/
    ...
    { 
      ...
      { 
        ...
        int32 [1] idxP; /*J2C:modeAccess=Q*/
        
        struct FieldJc_t const* [1] fieldP; /*J2C:modeAccess=Q*/
        ...
        { 
          ...
          { 
            ...
            { 
              ...
              struct ClassJc_t const* [1] retClazz; /*J2C:modeAccess=Q*/
...
{ 
  ...
  { 
    ...
    struct FieldJc_t const* [1] theFieldP; /*J2C:modeAccess=Q*/
...
{ 
  ...
  { 
    ...
    StringJc sValue ; sValue;/*no initvalue*/
...
{ 
  ...
  { 
    ...
    int8 [20] answerBuffer1; /*J2C:modeAccess=Q*/
    
    PtrVal_int8  answerBuffer.ref = & answerBuffer1[0]; answerBuffer.val = sizeof( answerBuffer1) / sizeof(answerBuffer1[0]);
