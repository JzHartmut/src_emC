  ...
  { 
    ...
    { /*:@Java4C.Exclude*/
      ...
      { 
        ...
        { throw_sJc(ident_IllegalArgumentExceptionJc, msg, 0, __LINE__, _thCxt); };
        activateGC_ObjectJc(&_tempString4_1->base.object, null, _thCxt);
      }
    }
...
{ 
  ...
  { 
    ...
    if(REFJc(child->parent)!= thiz) { throw_s0Jc(ident_IllegalArgumentExceptionJc, "programming error - child is not parent of this.", 0, __LINE__, _thCxt); };
...
{ 
  ...
  { 
    ...
    { throw_sJc(ident_IndexOutOfBoundsExceptionJc, textExc, 0, __LINE__, _thCxt); };
    activateGC_ObjectJc(&_tempString2_1->base.object, null, _thCxt);
  }
  STACKTRC_LEAVE;
}
