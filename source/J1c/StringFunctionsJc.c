...
{ 
  ...
  { 
    ...
    pos = start;
    cc = charAt_CharSequenceJc(src, pos);
    if(cc == '_' || (cc >= 'A' && cc <= 'Z') || (cc >= 'a' && cc <= 'z') || (additionalStartChars.ptr__!= null && indexOf_C_StringJc(additionalStartChars, cc) >= 0)) 
    { 
      
      pos += 1;
      
      while(pos < endMax && ((cc = /*? assignment*/charAt_CharSequenceJc(src, pos)) == '_' || (cc >= '0' && cc <= '9') || (cc >= 'A' && cc <= 'Z') || (cc >= 'a' && cc <= 'z') || (additionalChars.ptr__!= null && indexOf_C_StringJc(additionalChars, cc) >= 0)))
        { 
...
{ 
  ...
  { 
    ...
    int32 size; 
    int32 maxDigit; 
    int32 maxHexDigitLower = 'A'/*J2C: no cast found from char=char: ClassData@4a9dcd*/; 
    int32 maxHexDigitUpper = 'a'/*J2C: no cast found from char=char: ClassData@4a9dcd*/; 
...
{ 
  ...
  { 
    ...
    ret = parseIntRadix_SiiiiY_StringFunctionsJc(/*static*/src, pos, size, 10, zParsed);
    ...
    { 
      ...
      fracPart = parseIntRadix_SiiiiY_StringFunctionsJc(/*static*/src, ixsrc + 1, size - 1, 10, zParsed);
      if(zParsed->data[0] > 0) 
      { 
...
{ 
  ...
  { 
    ...
    z = nrofChars + from1;
    returnEq = 0;
    if(z > length_CharSequenceJc(s1)) 
    { 
      int32 nrofChars1; 
      int32 z2; 
      
      
      z = length_CharSequenceJc(s1);
      nrofChars1 = z - from1;
      z2 = from2 + nrofChars1;
      if(z2 == length_CharSequenceJc(s2)) 
      { 
        
        returnEq = 0;
      }//both have the same length after shorten.
      
      else if(z2 > length_CharSequenceJc(s2)) 
      { 
        int32 nrofChars2; 
        
        
        nrofChars2 = length_CharSequenceJc(s2) - from2;
    ...
    else if((from2 + nrofChars) > length_CharSequenceJc(s2)) 
    { //:s2 is shorter than the requested or adjusted length:
      
      
      z = (length_CharSequenceJc(s2) - from2) + from1;
      returnEq = 1;//returns 1 if equal because s2 is shorter
    ...
    while(++i1 < z)
      { 
        ...
        c1 = charAt_CharSequenceJc(s1, i1);
        c2 = charAt_CharSequenceJc(s2, ++i2);
        if(c1 != c2) 
        { 
...
{ 
  ...
  { 
    ...
    zz = to - from;
    if(zz != length_CharSequenceJc(s2)) { STACKTRC_LEAVE;
      return false;
    }
    else 
    { 
      ...
      { int32 ii; 
        for(ii = 0; ii < zz; ++ii)
          { 
            ...
            if(charAt_CharSequenceJc(s1, from + ii) != charAt_CharSequenceJc(s2, ii)) { STACKTRC_LEAVE;
            return false;
          }
          }
      }
...
{ 
  ...
  { 
    ...
    { STACKTRC_LEAVE;
      return equals_CsiiCs_StringFunctionsJc(/*static*/s1, 0, length_CharSequenceJc(s1), s2, _thCxt);
    }
  }
  STACKTRC_LEAVE;
}
...
{ 
  ...
  { 
    ...
    { STACKTRC_LEAVE;
      return compare_CsiCsii_StringFunctionsJc(/*static*/sq, 0, start, 0, length_CharSequenceJc(start), _thCxt) == 0;
    }
  }
  STACKTRC_LEAVE;
}
...
{ 
  ...
  { 
    ...
    zstart = length_CharSequenceJc(start);
...
{ 
  ...
  { 
    ...
    z = length_CharSequenceJc(end);
    if(z > length_CharSequenceJc(sq)) { STACKTRC_LEAVE;
      return false;
    }
    else { STACKTRC_LEAVE;
      return compare_CsiCsii_StringFunctionsJc(/*static*/sq, length_CharSequenceJc(sq) - z, end, 0, z, _thCxt) == 0;
    }
  }
  STACKTRC_LEAVE;
}
...
{ 
  ...
  { 
    ...
    /*no initvalue*/
    zz = length_CharSequenceJc(text);
    ii = -1;
    
    while(++ii < zz)
      { 
        
        cc = charAt_CharSequenceJc(text, ii);
  ...
  { 
    ...
    while(++ii < max)
      { 
        ...
        if(charAt_CharSequenceJc(sq, ii) == ch) 
        { 
...
{ 
  ...
  { 
    ...
    zsq = length_CharSequenceJc(sq);
    max = (to >= zsq ? zsq : to) - length_CharSequenceJc(str) + 1;
    ii = fromIndex - 1;
    if(fromIndex < 0) 
    { 
    ...
    ch = charAt_CharSequenceJc(str, 0);
    ...
    while(++ii < max)
      { 
        ...
        { //:search first char of str
          ...
          s1 = 0;
          { int32 jj; 
            for(jj = ii + 1; jj < ii + length_CharSequenceJc(str); ++jj)
              { 
                
                if(charAt_CharSequenceJc(sq, jj) != charAt_CharSequenceJc(str, ++s1)) 
                { 
  ...
  { 
    ...
    while(--max >= fromIndex)
      { 
        ...
        if(charAt_CharSequenceJc(sq, max) == ch) 
        { 
          int32 s1 = 0; 
          ...
          s1 = 0;
          { int32 jj; 
            for(jj = max + 1; jj < max + length_CharSequenceJc(str); ++jj)
              { 
...
struct CharSequenceJc_t* convertTranscription_StringFunctionsJc(/*static*/ struct CharSequenceJc_t* src, char transcriptChar, ThCxt* _thCxt)
{ 
  ...
  { 
    ...
    /*no initvalue*/
    posSwitch = indexOf_Csiic_StringFunctionsJc(/*static*/src, 0, length_CharSequenceJc(src), transcriptChar, _thCxt);
    if(posSwitch < 0) 
    { 
