...
int32 processInspcCommand(Cmd_InspcTargetProxyTelg_e const cmd, void const* const address, int32 const inputVal, void const* const mainData
, int32 const* const reflectionOffset_MainData, int32 const* const* const reflectionOffsetArrays)
{ int32 retVal;	
	switch( cmd )
	{
