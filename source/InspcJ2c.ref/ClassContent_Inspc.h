...
{ 
  ...
  SearchTrc_SearchElement_Inspc_Y* debugSearchTrc;   /*A debug helper to visit the search activity on access to any reflection element.*/
  int32 nrofAnswerBytes;   /*Current number while preparing a answer datagram. */
...
/**J2c: Definitions of the enhanced reference. It's conditinally because it may be defined in a included header before. */
  ...
  struct ClassContent_Inspc_t;
    ...
    typedef struct ClassContent_InspcREF_t STRUCT_REFJc(struct ClassContent_Inspc_t) ClassContent_InspcREF;
  #else
    //J2C: simple reference instead enhanced reference if macro is not defined
    #define ClassContent_InspcREF struct ClassContent_Inspc_t* 
  #endif
#endif
...
METHOD_C void setRootObject_ClassContent_Inspc(ClassContent_Inspc_s* ythis, struct ObjectJc_t* rootObj, ThCxt* _thCxt);
...
METHOD_C int32 executeMonitorCmd_XXXXi_ClassContent_Inspc(ObjectJc* ithis, struct Info_InspcDataExchangeAccess_Inspc_t* cmd, struct Datagram_InspcDataExchangeAccess_Inspc_t* answer, int32 maxNrofAnswerBytes, ThCxt* _thCxt);
