...
/**J2c: Definitions of the enhanced reference. It's conditinally because it may be defined in a included header before. */
  ...
  struct SearchTrc_SearchElement_Inspc_t;
    ...
    typedef struct SearchTrc_SearchElement_InspcREF_t STRUCT_REFJc(struct SearchTrc_SearchElement_Inspc_t) SearchTrc_SearchElement_InspcREF;
  #else
    //J2C: simple reference instead enhanced reference if macro is not defined
    #define SearchTrc_SearchElement_InspcREF struct SearchTrc_SearchElement_Inspc_t* 
  #endif
#endif
...
/**J2c: Definitions of the enhanced reference. It's conditinally because it may be defined in a included header before. */
  ...
  #ifdef STRUCT_REFJc
    //J2C: macro STRUCT_REFJc should be defined in <fw_Platform_conventions.h> 
    typedef struct SearchElement_InspcREF_t STRUCT_REFJc(struct SearchElement_Inspc_t) SearchElement_InspcREF;
  #else
    //J2C: simple reference instead enhanced reference if macro is not defined
    #define SearchElement_InspcREF struct SearchElement_Inspc_t* 
  #endif
#endif
