 ...
 */
  ...
  struct LinkedListJc_t;
    ...
    typedef struct LinkedListJcREF_t STRUCT_REFJc(struct LinkedListJc_t) LinkedListJcREF;
  #else
    //J2C: simple reference instead enhanced reference if macro is not defined
    #define LinkedListJcREF struct LinkedListJc_t* 
  #endif
#endif
...
/**J2c: Definitions of the enhanced reference. It's conditinally because it may be defined in a included header before. */
  ...
  #ifdef STRUCT_REFJc
    //J2C: macro STRUCT_REFJc should be defined in <fw_Platform_conventions.h> 
    typedef struct Data_ExampleInspector_InspcREF_t STRUCT_REFJc(struct Data_ExampleInspector_Inspc_t) Data_ExampleInspector_InspcREF;
  #else
    //J2C: simple reference instead enhanced reference if macro is not defined
    #define Data_ExampleInspector_InspcREF struct Data_ExampleInspector_Inspc_t* 
  #endif
#endif
...
/**J2c: Definitions of the enhanced reference. It's conditinally because it may be defined in a included header before. */
  ...
  #ifdef STRUCT_REFJc
    //J2C: macro STRUCT_REFJc should be defined in <fw_Platform_conventions.h> 
    typedef struct ExampleInspector_InspcREF_t STRUCT_REFJc(struct ExampleInspector_Inspc_t) ExampleInspector_InspcREF;
  #else
    //J2C: simple reference instead enhanced reference if macro is not defined
    #define ExampleInspector_InspcREF struct ExampleInspector_Inspc_t* 
  #endif
#endif
