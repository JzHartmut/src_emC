...
/**J2c: Definitions of the enhanced reference. It's conditinally because it may be defined in a included header before. */
  ...
  struct CmdExecuter_Inspc_t;
    ...
    typedef struct CmdExecuter_InspcREF_t STRUCT_REFJc(struct CmdExecuter_Inspc_t) CmdExecuter_InspcREF;
  #else
    //J2C: simple reference instead enhanced reference if macro is not defined
    #define CmdExecuter_InspcREF struct CmdExecuter_Inspc_t* 
  #endif
#endif
