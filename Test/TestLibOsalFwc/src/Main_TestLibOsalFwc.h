 ...
 **copyright***************************************************************************************
 *
 * @content This source should only be test the link ability of all sources. 
 * It uses at least one routine form any module to check link.
 * @version 0.94
 * list of changes:
...
extern_C void testFile(void);
extern_C void testThread(void);
