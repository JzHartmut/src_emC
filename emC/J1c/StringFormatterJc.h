...
{ public:
  ...
  StringFormatterJc(struct AppendableJc_t* lineout, bool shouldClose, StringJcpp newlineString, int32 defaultBufferLength){ iniz_ObjectJc(&this->base.object, this, sizeof(StringFormatterJc_s), &reflection_StringFormatterJc, 0); ctorO_ApbSi_StringFormatterJc(&this->base.object, lineout, shouldClose, newlineString, defaultBufferLength,  null/*_thCxt*/); }

  StringFormatterJc(StringJcpp str){ iniz_ObjectJc(&this->base.object, this, sizeof(StringFormatterJc_s), &reflection_StringFormatterJc, 0); ctorO_S_StringFormatterJc(&this->base.object, str,  null/*_thCxt*/); }
  ...
  StringFormatterJc(){ iniz_ObjectJc(&this->base.object, this, sizeof(StringFormatterJc_s), &reflection_StringFormatterJc, 0); ctorO_StringFormatterJc(&this->base.object,  null/*_thCxt*/); }

  StringFormatterJc(int32 length){ iniz_ObjectJc(&this->base.object, this, sizeof(StringFormatterJc_s), &reflection_StringFormatterJc, 0); ctorO_i_StringFormatterJc(&this->base.object, length,  null/*_thCxt*/); }
