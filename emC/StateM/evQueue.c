...
#else
  #define ID_refl_EvListener_StateM_vishiaOrg 0x0fd0
  #define ID_refl_EvCreator_StateM_vishiaOrg 0x0fd1
  #define ID_refl_EvInstance_StateM_vishiaOrg 0x0fd2
  #define ID_refl_EvQueue_StateM_vishiaOrg 0x0fd3
