 ...
 * @return ,,char*,,-pointer to the buffer.
 */
METHOD_C char const* getCharsAndCount_StringBuilderJc (StringBuilderJc_s const* thiz, int* count);
 ...
 */
METHOD_C char charAt_StringBuilderJc (StringBuilderJc_s const* ythis, int index, struct ThreadContext_emC_t* _thCxt);
 ...
 */
METHOD_C int copyToBuffer_StringBuilderJc (StringBuilderJc_s const* thiz, int start, int end, char* buffer, int zBuffer);
 ...
 */ 
METHOD_C StringBuilderJc_s* append_u_StringBuilderJc (StringBuilderJc_s* ythis, StringBuilderJc_s const* src, struct ThreadContext_emC_t* _thCxt);
