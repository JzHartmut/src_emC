...
{ ObjectJc object;
  ...
  union { ObjectJc const* obj; struct ClassJc_t const* clazz; struct ClassOffset_idxVtblJcARRAY_t const* clazzArray; struct ClassOffset_idxVtblJc_t const* clazzVtbl; } superClass_es;
