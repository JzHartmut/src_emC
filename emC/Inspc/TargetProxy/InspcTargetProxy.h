...
#include <emC/Ipc/Ipc2C/InterProcessCommRxThread_Ipc.h>
...
class InspcTargetProxy : InspcTargetProxy_s {
  ...
  public: virtual int32 accessTarget(Cmd_InspcTargetProxy_e cmd, int device, uint32 address, int32 input) =0;
...
class InspcTargetProxySharedMem : InspcTargetProxy {
  ...
  protected: int32 accessTarget(Cmd_InspcTargetProxy_e cmd, int device, uint32 address, int32 input);
