 ...
 *     sondern nur die allgemeing�ltigen. Alle anderen Fehlercodes als Sub-code nicht umgesetzt melden,
 *     die Software sollte direkt darauf nicht reagieren. Das ganze ist noch nicht richtig durchdesignet.
 *   new: Fehlermeldung mit Routinen �hnlich wie es in der Hynet-OS-Schale getan wird, aber hier �ber Funktionspointer,
 *     dazu gibt es:
...
#define OS_INVALID_PARAMETER -101	// Ein Parameter war ung�ltig.
#define OS_INVALID_STRING	   -102	// Ein String ist nicht innerhalb der vorgegebenen Gr��e.
#define OS_INVALID_HANDLE    -103	// Das Objekt-Handle ist ung�ltig.
//#define OS_INVALID_STATE     -104	// Der Objekt-Sustand ist ung�ltig f�r diese Operation.
//#define OS_TEST_NOT_OK       -105	// Testbedingungen nicht erf�llt.
#define OS_GOT_TIMEOUT       -106	// Der Aufruf wurde nach dem eingestellten Timeout abgebrochen.
//#define OS_QUEUE_EXIST       -107	// Die Message-Queue existiert bereits f�r diesen Thread.
...
//#define OS_QUEUE_EMPTY       -111	// Die Message-Queue enth�lt keine Nachricht
...
//#define OS_MAILBOX_FULL      -114	// Die Anforderung �berschreitet die eingetragene Grenze der Mailbox.
//#define OS_MAILBOX_EMPTY     -115	// Die Mailbox enth�lt keine Nachricht (wenn timeOut = 0).
#define OS_INVALID_POINTER   -116	// Zeiger zu Resource ung�ltig.
