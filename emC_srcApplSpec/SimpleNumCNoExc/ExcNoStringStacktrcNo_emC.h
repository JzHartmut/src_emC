...
//#error too much complexity

#ifndef INCLUDED_emC_ApplSpec_ExcNoStringStacktrcNo_emC_h
#define INCLUDED_emC_ApplSpec_ExcNoStringStacktrcNo_emC_h
...
#endif //INCLUDED_emC_ApplSpec_ExcNoStringStacktrcNo_emC_h
